package cscie57.assignment2_2.config;
...
@ComponentScan(basePackages = "cscie57.assignment2_2")
...
public class AppConfig {
    ...
    public DataSource dataSource() {
        try {
            ...
            logger.error("DataSource not able to be created: ", e);
            return null;
        }
    }
    ...
    @Bean public SessionFactory sessionFactory() throws IOException {
        ...
        sessionFactoryBean.setPackagesToScan("cscie57.assignment2_2");
